...
describe('Temperature Converter', () => {
  describe('convertTemperature function', () => {
    ...
    it('should return null for invalid to unit', () => {
      // Temperature converter doesn't validate to unit in current implementation
      // It returns the original value when to unit is invalid
      expect(convertTemperature(25, 'C', 'invalid')).toBe(25);
    });
